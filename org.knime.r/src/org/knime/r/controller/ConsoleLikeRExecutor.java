...
/**
 * Class which wraps all R and Java code necessary to execute R code with correct errors (inkl. syntax errors), output
 * capturing and printing of the result.
 *
...
public class ConsoleLikeRExecutor {
    ...
    /**
     * R code for executing a script, catching errors (including syntax errors), and handling printing the value
     * correctly.
     *
     * <pre>
     * <code>
