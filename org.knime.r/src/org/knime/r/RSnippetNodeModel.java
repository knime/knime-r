...
public class RSnippetNodeModel extends ExtToolOutputNodeModel implements InteractiveNode<RSnippetViewContent> {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        FlowVariableRepository flowVarRepo =
            new FlowVariableRepository(getAvailableInputFlowVariables());
        ValueReport<BufferedDataTable> out = m_snippet.execute(inData[0], flowVarRepo, exec);
        if (out.hasWarnings()) {
