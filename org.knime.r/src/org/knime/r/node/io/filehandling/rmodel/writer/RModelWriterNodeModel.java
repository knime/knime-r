 ...
 */
final class RModelWriterNodeModel extends PortObjectToFileWriterNodeModel<RModelWriterNodeConfig> {
     ...
     */
    RModelWriterNodeModel(final NodeCreationConfiguration creationConfig) {
        super(creationConfig, new RModelWriterNodeConfig());
    }
