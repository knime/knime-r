...
public class RSnippetTemplate {
    ...
    public static RSnippetTemplate create(final NodeSettingsRO settings) {
        RSnippetTemplate template = new RSnippetTemplate();
     ...
     */
    public RSnippetTemplate(final Class metaCategory,
            final RSnippetSettings snippetSettings) {
    ...
    public void loadSettings(final NodeSettingsRO settings) {
        try {
            ...
            m_metaCategory = metaCategory != null
                ? Class.forName(metaCategory) : RSnippetTemplate.class;
    ...
    public boolean equals(final Object obj) {
        ...
        RSnippetTemplate other = (RSnippetTemplate)obj;
        if (m_uuid == null) {
