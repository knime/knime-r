 ...
 * @since 2.7
 */
public class RLocalRData2RNodeDialogPane extends RLocalNodeDialogPane {

    private final RDialogPanel m_dialogPanel;

    /**
     * Constructor which creates a new instance of <code>RLocalRData2RNodeDialogPane</code>.
     */
    public RLocalRData2RNodeDialogPane() {
        m_dialogPanel = new RDialogPanel();
        m_dialogPanel.setText(RLocalRData2RNodeModel.DEFAULT_R_CMD);
