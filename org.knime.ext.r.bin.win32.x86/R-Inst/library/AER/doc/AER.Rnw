...
\Abstract{
  ...
  for statistical computing and graphics \citep{aer:R:2010}. 
  ...
  \pkg{AER} \citep{aer:Kleiber+Zeileis:2010} which contains some new \proglang{R}
...
\Address{
  ...
  URL: \url{http://wwz.unibas.ch/kleiber/}\\
...
The following errors have been found in the book so far.
...
The ASA journals manager currently appears to supply data on a case-by-case basis. The problem awaits a more permanent solution.
