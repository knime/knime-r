...
###################################################
### code chunk number 1: TSP.Rnw:80-83
###################################################
options(width = 75)
### for sampling
set.seed(1234)
...
###################################################
### code chunk number 2: TSP.Rnw:644-647
###################################################
library("TSP")
data("USCA50")
USCA50
...
###################################################
### code chunk number 3: TSP.Rnw:660-661
###################################################
set.seed(1234)
...
###################################################
### code chunk number 5: TSP.Rnw:709-710
###################################################
set.seed(1234)


###################################################
### code chunk number 6: TSP.Rnw:713-717
###################################################
library("TSP")
data("USCA312")
...
###################################################
### code chunk number 7: TSP.Rnw:723-726
###################################################
...
###################################################
### code chunk number 8: TSP.Rnw:735-738
###################################################
...
###################################################
### code chunk number 14: TSP.Rnw:854-857 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 15: TSP.Rnw:879-880
###################################################
set.seed(1234)


###################################################
### code chunk number 16: TSP.Rnw:883-893
###################################################
m <- as.matrix(USCA312)
ny <- which(labels(USCA312) == "New York, NY")
...
###################################################
### code chunk number 17: TSP.Rnw:898-907
###################################################
...
###################################################
### code chunk number 19: TSP.Rnw:951-952
###################################################
set.seed(4444)


###################################################
### code chunk number 20: TSP.Rnw:954-959
###################################################
data("iris")
...
###################################################
### code chunk number 22: TSP.Rnw:997-1007
###################################################
## labels(tour)
