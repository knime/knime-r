...
###################################################
### code chunk number 16: over.Rnw:260-264
###################################################
plot(pol, xlim = c(-1.1, 2.1), ylim = c(-1.1, 1.6), border=2:6, axes=TRUE)
...
###################################################
### code chunk number 17: over.Rnw:272-281
###################################################
library(rgeos)
over(pol, pol)
...
###################################################
### code chunk number 18: over.Rnw:286-294
###################################################
data(meuse.grid)
...
###################################################
### code chunk number 19: over.Rnw:305-311
###################################################
data(meuse.grid)
gridded(meuse.grid) = ~x+y
...
###################################################
### code chunk number 20: over.Rnw:321-323
###################################################
image(agg)
...
###################################################
### code chunk number 21: over.Rnw:332-335
###################################################
