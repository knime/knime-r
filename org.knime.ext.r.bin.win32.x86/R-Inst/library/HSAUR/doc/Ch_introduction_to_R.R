...
###################################################
### code chunk number 77: AItR-Forbes2000-marketvalue-sales-shading
###################################################
plot(log(marketvalue) ~ log(sales), data = Forbes2000, 
     col = rgb(0,0,0,0.1), pch = 16)
...
###################################################
### code chunk number 78: AItR-Forbes2000-country-plot (eval = FALSE)
###################################################
...
###################################################
### code chunk number 79: AItR-Forbes2000-country-plot
###################################################
...
###################################################
### code chunk number 80: AItR-analysis1
###################################################
file.create("analysis.R")


###################################################
### code chunk number 81: AItR-analysis2 (eval = FALSE)
###################################################
## source("analysis.R", echo = TRUE)


###################################################
### code chunk number 82: AItR-analysis3
###################################################
