...
###################################################
### code chunk number 19: sandwich.Rnw:785-786
###################################################
options(prompt = "  ")


###################################################
### code chunk number 20: sandwich.Rnw:804-806 (eval = FALSE)
###################################################
## library("sandwich")
## library("lmtest")
## library("strucchange")
...
###################################################
### code chunk number 21: sandwich.Rnw:813-814 (eval = FALSE)
###################################################
## data("PublicSchools")
## ps <- na.omit(PublicSchools)
## ps$Income <- ps$Income * 0.0001
...
###################################################
### code chunk number 22: sandwich.Rnw:818-819 (eval = FALSE)
###################################################
## fm.ps <- lm(Expenditure ~ Income + I(Income^2), data = ps)


###################################################
### code chunk number 23: sandwich.Rnw:823-828 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 24: sandwich.Rnw:832-834 (eval = FALSE)
###################################################
## coeftest(fm.ps, df = Inf, vcov = vcovHC(fm.ps, type = "HC0"))
## coeftest(fm.ps, df = Inf, vcov = vcovHC(fm.ps, type = "HC4"))
...
###################################################
### code chunk number 25: sandwich.Rnw:854-855 (eval = FALSE)
###################################################
## data("Investment")


###################################################
### code chunk number 26: sandwich.Rnw:859-860 (eval = FALSE)
###################################################
## fm.inv <- lm(RealInv ~ RealGNP + RealInt, data = Investment)


###################################################
### code chunk number 27: sandwich.Rnw:878-880 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 28: sandwich.Rnw:896-897 (eval = FALSE)
###################################################
## data("RealInt")


###################################################
### code chunk number 29: sandwich.Rnw:901-904 (eval = FALSE)
###################################################
## ocus <- gefp(RealInt ~ 1, fit = lm, vcov = kernHAC)
...
###################################################
### code chunk number 30: sandwich.Rnw:908-911 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 31: sandwich.Rnw:916-918 (eval = FALSE)
###################################################
## bp <- breakpoints(RealInt ~ 1)
## confint(bp, vcov = kernHAC)
## plot(bp)
...
###################################################
### code chunk number 32: sandwich.Rnw:922-925 (eval = FALSE)
###################################################
## plot(RealInt, ylab = "Real interest rate")
## lines(ts(fitted(bp), start = start(RealInt), freq = 4), col = 4)
## lines(confint(bp, vcov = kernHAC))
