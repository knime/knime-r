...
namespace eval ttk::theme::aquablue {

    package provide ttk::theme::aquablue 0.1
    ...
    array set I [LoadImages \
                     [file join [file dirname [info script]] aquablue] *.gif]
    ...
    #Note that editable text uses Helvetica, and fixed font is Menlo 12 (or Monaco 12)

    ttk::style theme create aquablue -parent clam -settings {
