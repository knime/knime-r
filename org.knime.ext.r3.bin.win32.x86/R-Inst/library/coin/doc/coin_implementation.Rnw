...
challenging because of the many ties in the (censored) response ($\Sexpr{sum(rotarod$time == 300)}$
...
Henric Winell provided clarification and examples for the Maxwell-Stuart test and helped
